...
should make multiple pieces of toasts and once. So, you 
try to make 6 pieces of toast.
...
Examples:
You must return the number of toast the you need to put in (or 
to take out). In case of 5 you can still put 1 toast in:
