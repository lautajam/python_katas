...
# Takes the monkeys number and creates a list with the count
def count_monkeys(number_monkeys):
    monkeys = []
    for num in range(1, number_monkeys + 1):
        monkeys.append(num)
    return monkeys
...
print(count_monkeys(number_monkeys))